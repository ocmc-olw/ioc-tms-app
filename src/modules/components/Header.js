              ...
              <Nav>
                {this.props.app.session.userInfo.authenticated ?
                    <LinkContainer to="/add">
                      <NavItem eventKey={"add"}>{<FontAwesome className="App-header-ico"  name="plus"/>} {this.props.app.session.localLabels.add.menu}</NavItem>
                    </LinkContainer>
                    : ""
                }
                {this.props.app.session.userInfo.authenticated ?
                    <NavDropdown eventKey={"edit"} title={<span><FontAwesome name="pencil-square-o"/> {this.props.app.session.localLabels.edit.menu}</span>} id="notes-nav-dropdown">
                ...
                {this.props.app.session.userInfo.authenticated ?
                    <NavDropdown eventKey={"generate"} title={<span><FontAwesome name="cogs"/> {this.props.app.session.localLabels.generate.menu}</span>} id="notes-nav-dropdown">
                ...
                {this.props.app.session.userInfo.authenticated ?
                    <NavDropdown eventKey={"search"} title={<span><FontAwesome name="search"/> {this.props.app.session.localLabels.search.menu}</span>} id="notes-nav-dropdown">
                      <LinkContainer to="/searchlinks"><NavItem  className="App-submenu-item" eventKey={"search.links"} >{<FontAwesome className="App-header-ico"  name="chain"/>}{this.props.app.session.localLabels.search.itemLink}</NavItem></LinkContainer>
                      <LinkContainer to="/searchnotes"><NavItem  className="App-submenu-item" eventKey={"search.notes"} >{<FontAwesome className="App-header-ico"  name="comment-o"/>}{this.props.app.session.localLabels.search.itemNote}</NavItem></LinkContainer>
                      <LinkContainer to="/searchontology"><NavItem  className="App-submenu-item" eventKey={"search.ontology"} >{<FontAwesome className="App-header-ico"  name="sitemap"/>}{this.props.app.session.localLabels.search.itemOntology}</NavItem></LinkContainer>
                      <LinkContainer to="/searchtext"><NavItem  className="App-submenu-item" eventKey={"search.text"} >{<FontAwesome className="App-header-ico"  name="file-text-o"/>}{this.props.app.session.localLabels.search.itemText}</NavItem></LinkContainer>
                    </NavDropdown>
                    :
                    ""
                }
