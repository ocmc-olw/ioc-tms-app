...
const   labels = {
  en: {
    ...
    , about: {
      ...
      , p4: "New user accounts are created by administrators who have verified the identity of the individual and his/her need for access to the system."
  ...
  , el: {
    home: {
      p1: "Καλωσορίσατε στους μεταφραστές των λειτουργικών κειμένων, και τους μαθητευόμενους που δημιουργούν πηγές που θα μας βοηθήσουν να καταλάβουμε το νόημα των κειμένων!"
    ...
    , loginPage: {
      msg1: "Προκειμένου να συνδεθείτε, θα πρέπει να συμφωνείτε με τους όρους χρήσης και την πολιτική απορρήτου."
      , msg2: "Διάβασα και συμφωνώ με  τους όρους χρήσης και την πολιτική απορρήτου."
    }
    , paratexts: {
    ...
    , about: {
      ...
      , p3: "Σκοπός του OLW είναι να εξασφαλίσει ένα ασφαλές περιβάλλον για όσους θέλουν να δημιουργήσουν, να διαχειριστούν και να δημοσιεύσουν μεταφράσεις λειτουργικών κειμένων από την Ανατολική Ορθόδοξη Εκκλησία. Επίσης, μπορεί να χρησιμοποιηθεί για άλλου είδους υλικό, όπως καθημερινή ανάγνωση, εκπαιδευτικό ή κατηχητικά κείμενα."
      , p4: "Οι νέοι λογαριασμοί χρηστών δημιουργούνται από τους διαχειριστές που επαληθεύουν την ταυτότητα του ατόμου και την ανάγκη του για πρόσβαση στο σύστημα."
      ...
      , userFeature07: "Παραγωγή σημειώσεων για προσωπική χρήση, οι οποίες θα είναι ορατές μόνο από το συγκεκριμένο χρήστη εκτός εάν αυτός/αυτή θέλει να το μοιραστεί με άλλους."
      ...
      , securityFeature05: "Όλες οι καταχωρήσεις έχουν ένα πεδίο προβολής:Προσωπικό,Ιδιωτικό, ή Δημόσιο. Αν η προβολή είναι «Προσωπική», μόνο ο διαχειριστής βιβλιοθήκης μπορεί να το δει ή να το διορθώσει. Αν η προβολή είναι «Ιδιωτική», μόνο όσοι έχουν πρόσβαση μπορούν να το δουν ή να το διορθώσουν. Αν η προβολή είναι«Δημόσια», όλοι μπορούν να το δουν."
      ...
      , securityFeature07: "Όταν η καταχώρηση δημιουργείται ή ενημερώνεται, η καταχώρηση περιέχει το όνομα χρήστη, την ημερομηνία και την ώρα στην οποία η καταχώρηση δημιουργήθηκε και/ή ενημερώθηκε.  Είναι δυνατό να ορίζεται κάθε βήμα της διαδικασίας, ποιος τροποποιεί, τι και πότε."
    ...
    , help: {
      title: "Βοήθεια"
      , intro: "Παρακάτω θα βρείτε οδηγίες για το πως να κάνετε διάφορα πράγματα. Επίσης υπάρχουν και βίντεο. Ακόμα κι αν δε συνηθίζετε να βλέπετε βίντεο για το πως να χρησιμοποιείτε ένα λογισμικό, παρακαλούμε να δείτε το βίντεο στο  Grammar Explorer.  Είναι σημαντικό να διαβάσετε την ενότητα με τίτλο «Πώς να ψάχνετε στη Λειτουργική Βάση Δεδομένων. Θα σας βοηθήσει να κατανοήσετε καλύτερα πως λειτουργεί η βάση δεδομένων."
      , videos: "Πώς να..."
      , videoWarning: "Μπορεί να χρειαστούν μερικά δευτερόλεπτα ή και παραπάνω για να φορτώσει το βίντεο. Ο χρόνος φόρτωσης εξαρτάται από την ταχύτητα του δικτύου σας. Αν ένα βίντεο δεν αρχίσει να παίζει κατευθείαν, παρακαλώ περιμένετε. Αν δείτε έναν περιστρεφόμενο τροχό στο βίντεο, προχωρήστε  πληκτρολογώντας το πλήκτρο εκκίνησης."
      ...
      , videoChangeLanguage: "Πώς αλλάζει η γλώσσα του περιβάλλοντος χρήστη"
      ...
      , videoDailyReadings: "Πώς να δημιουργήσετε τα καθημερινά κείμενα"
      , videoDailyReadingsText: "Αναφορικά με τις Καθημερινές Αναγνώσεις, σημειώστε ότι υπάρχουν αντικαταστάτες για τις γιορτές ή τη μνήμη των αγίων [saint/com] και για αφηγηματικές περιγραφές των εορτών ή της ζωής των αγίων [paragraph]. Μπορείτε να τα συμπληρώσετε για τη δικιά σας συγκεκριμένη γλώσσα. Αν δεν καταχωρήσετε έναν εορτασμό ή μία παράγραφο, θα αφαιρεθεί όταν θα δημιουργηθούν οι καθημερινές αναγνώσεις"
      , videoSelectService: "Πώς να επιλέξετε μια Υπηρεσία ή ένα Λειτουργικό Βιβλίο από το AGES DCS"
      , videoSelectServiceText: "Τόσο ο Συντάκτης όσο και ο Δημιουργός σάς επιτρέπουν να επιλέξετε μια υπηρεσία AGES ή ένα πρότυπο βιβλίου. Αυτά τα πρότυπα μπορούν να χρησιμοποιηθούν εκ νέου για κάθε γλώσσα που υπάρχει στη βάση δεδομένων"
      , videoGenerateService: "Πώς να δημιουργήσετε μια υπηρεσία ή ένα λειτουργικό βιβλίο"
      , videoGenerateServiceText: "Μπορείτε να δημιουργήσετε υπηρεσίες ή βιβλία για μία, δύο ή τρεις γλώσσες τη μία δίπλα στην άλλη. Αν κάποιο μέρος δεν έχει μεταφραστεί στη γλώσσα που επιλέξατε, θα το βρείτε στα Αγγλικά ή στα Ελληνικά. Αυτές ονομάζονται «εφεδρικές» γλώσσες."
      , videoEnterTranslation: "Πώς να εισάγεται μια μετάφραση"
      ...
      , videoCreateNote: "Πώς να δημιουργήσετε μια σημείωση"
      ...
      , videoSearchNotes: "Πώς να κάνετε αναζήτηση κειμένων"
      ...
      , videoSearchText: "Πώς να κάνετε αναζήτηση σημειώσεων"
      ...
      , videoCreateTag: "Πώς να δημιουργήσετε ή να διορθώσετε τις ετικέτες των σημειώσεων"
      ...
      , videoTagSearch: "Πώς να χρησιμοποιείτε  τις ετικέτες για την αναζήτηση σημειώσεων"
      ...
      , videoNoteDownload: "Πώς να κάνετε λήψη των σημειώσεων ως json"
      ...
      , videoGrammar: "Πώς να χρησιμοποιείτε το Grammar Explorer"
    ...
    , privacyPolicy: {
      ...
      , aboutThisPolicy: "Σχετικά με την πολιτική"
      , aboutThisPolicyText: "Σύμφωνα με τους Όρους της Υπηρεσίας, αυτή η πολιτική εξηγεί πώς να συλλέγουμε και να χειριζόμαστε την πληροφορία σας. Θα επανεξετάσουμε την πολιτική στο πέρασμα του καιρού για να βεβαιώσουμε ότι παραμένει ανανεωμένη. Αν κάνουμε αλλαγές, θα κοινοποιήσουμε την τελευταία έκδοση εδώ. Όταν κάνουμε σημαντικές αλλαγές, θα σας γνωστοποιούμε πότε θα γίνει η επόμενη πρόσβαση στις υπηρεσίες μας ή με άλλες ειδοποιήσεις."
      , personalDataUse: "Γιατί και πώς χρησιμοποιούμε τα προσωπικά δεδομένα σας;"
      , personalDataUseText: "Χρησιμοποιούμε την πληροφορία σας μόνο όπου μας έχετε δώσει τη συγκατάθεσή σας, όπου είναι απαραίτητο για τις υπηρεσίες που ζητάτε, όπου είναι απαραίτητο να ασκήσετε ή να συμμορφωθείτε με τα νόμιμα δικαιώματα ή τις υποχρεώσεις  ή για φυσιολογικούς επιχειρηματικούς σκοπούς όπως αυτοί ορίζονται από την παρούσα πολιτική."
      , personalDataCollected: "Ποιά προσωπικά δεδομένα συλλέγουμε;"
      , personalDataCollectedText: "Αν δεν έχετε λογαριασμό, καμία προσωπική πληροφορία δε συλλέγεται. Όσοι έχουν λογαριασμό χρήστη και χρησιμοποιούν τις υπηρεσίες μας, θα πληροφορούνται σχετικά με αυτά που συλλέγουμε, αποθηκεύουμε και επεξεργαζόμαστε. Ωστόσο, δε συλλέγουμε περισσότερες πληροφορίες από αυτές που χρειαζόμαστε. Ο λογαριασμός σας χρήστη έχει το όνομα χρήστη, το όνομά σας, το επίθετό σας, τον τίτλο σας, π.χ. Κ. ή Δρ.  ή Π., και τη διεύθυνση του ηλεκτρονικού σας. Υπάρχει επίσης ιστορικό της ημέρας και της ώρας που είχατε τελευταία φορά πρόσβαση στο σύστημα. Όταν δημιουργείτε ή ενημερώνετε το ιστορικό σας συμπεριλαμβάνεται και το όνομα χρήστη. Αυτό γίνεται για να διασφαλίσει ότι υπάρχει ένας τρόπος που να καθορίζει ποιος αλλάζει την πληροφορία. "
      , personalDataHowLong: "Πόσο διαρκεί η αποθήκευση των προσωπικών δεδομένων;"
      , personalDataHowLongText: "Κρατάμε τα δεδομένα σας μόνο για το διάστημα που ο λογαριασμός σας είναι ανοιχτός. Αν μας ζητήσετε να διαγράψουμε τον λογαριασμό σας, τότε οι προσωπικές σας πληροφορίες θα διαγραφούν. Οι καταχωρήσεις στην προσωπική σας βιβλιοθήκη θα διαγραφούν. Αν έχετε άδεια για να δημιουργήσετε ή να ενημερώσετε καταχωρήσεις σε μία μη-προσωπική βιβλιοθήκη, θα αντικαταστήσουμε το όνομά σας με ανωνυμία ώστε να μη σας ταυτοποιεί. Μπορείτε να μας ζητήσετε να διαγράψουμε τα προσωπικά σας δεδομένα οποιαδήποτε στιγμή."
      , thirdParty: "Πότε οι πληροφορίες σας μοιράζονται σε τρίτους ή συλλέγονται από τρίτους;"
      , thirdPartyText: "Μοιραζόμαστε την πληροφορία σας μόνο όπου μας ζητάτε να το κάνουμε, όπου είναι απαραίτητη μια υπηρεσίας για σας ή όπου το χρειαζόμαστε για νομικούς λόγους."
      , personalDataSecurity: "Πως διατηρούμε τα προσωπικά σας δεδομένα ασφαλή;"
      , personalDataSecurityText: "Χρησιμοποιούμε βιομηχανικές προδιαγραφές για τηνπροστασία των δεδομένων σας. Χρησιμοποιούμε HTTPS κρυπτογράφηση για την επικοινωνία στο Διαδίκτυο. Τα δεδομένα που περιέχουν τις πληροφορίες είναι προστατευμένα με όνομα χρήστη και κωδικό πρόσβασης.  Η ηλεκτρονική πρόσβαση στις πληροφορίες σας, περιορίζεται σε εσάς και τους διαχειριστές λογαριασμών. Οι διακομιστές μπορούν να συνδεθούν μέσω των διακομιστών των διαχειριστών με το κατάλληλο κλειδί κρυπτογράφησης."
      , personalDataWhereStored: "Πού αποθηκεύουμε τις πληροφορίες σας;"
      , personalDataWhereStoredText: "Αποθηκεύουμε την πληροφορία σας στους διακομιστές των Ηνωμένων Πολιτειών Αμερικής."
      , personalDataAdvertising: "Πώς η πληροφορία σας χρησιμοποιείται για διαφήμιση;"
      , personalDataAdvertisingText: "Δε χρησιμοποιούμε την πληροφορία σας για διαφήμιση."
      , cookies: "Χρησιμοποιούμε cookies?"
      , cookiesText: "Δε χρησιμοποιούμε cookies."
      , links: "Τί συμβαίνει όταν πληκτρολογώ ένα σύνδεσμο και με στέλνει σε άλλη ιστοσελίδα;"
      , linksText: "Περιστασιακά ο ιστότοπός μας παρέχει πρόσβαση σε άλλους ιστοτόπους με την πληκτρολόγηση σε αυτούς. Δεν είμαστε υπεύθυνοι για τις πολιτικές δεδομένων (συμπεριλαμβανομένου της προστασίας δεδομένων και των cookies), περιεχόμενο ή ασφάλεια των πληκτρολογημένων ιστότοπων. Επομένως, είναι καλή ιδέα να βεβαιώνεστε ότι έχετε ανατρέξει στις πολιτικές απορρήτου ώστε να σιγουρεύεστε ότι γνωρίζετε πώς χρησιμοποιούν τα δεδομένα σας."
      , choicesAndRights: "Ποιές είναι οι επιλογές σας και τα δικαιώματά σας;"
      , choicesAndRightsText: "Αν έχετε λογαριασμό χρήστη, μπορείτε να μας ζητήσετε οπιαδήποτε στιγμή να διαγράψουμε το λογαριασμό σας. Μπορείτε, επίσης, να κάνετε λήψη των προσωπικών σας καταχωρήσεων χρησιμοποιώντας «Οι καταχωρήσεις μου» στη στήλη μενού."
      , whoAreWe: "Ποιοί είμαστε και πώς μπορείτε να επικοινωνήσετε μαζί μας;"
      , whoAreWeText: "Αυτός ο ιστότοπος παρέχεται από το Ορθόδοξο Χριστιανικό Αποστολικό Κέντρο(OCMC), στον Άγιο Αυγουστίνο, ΦΛ, ΗΠΑ. Στο κάτω μέρος της σελίδας «Σχετικά», υπάρχει μια διεύθυνση ηλεκτρονικού ταχυδρομείου για να επικοινωνείτε μαζί μας."
      , optOut: "Πώς επικοινωνείτε μαζί μου;"
      , optOutText: "Αν χρειαστεί,θα επικοινωνήσουμε μαζί σας μέσω ηλεκτρονικού ταχυδρομείου. Αν θέλετε να εγγραφείτε στο ενημερωτικό μας δελτίο, στείλτε μας ηλεκτρονικό μήνυμα (δείτε στο κάτω μέρος της σελίδας Σχετικά). Αν εγγραφείτε στο ενημερωτικό μας δελτίο και αλλάξετε γνώμη, υπάρχει σύνδεσμος διαγραφής στο κάτω μέρος του ενημερωτικού δελτίου."
    }
    , termsOfUse: {
      title: "Όροι χρήσης"
      , disclaimer: "Η υπηρεσία που παρέχουμε είναι ο ιστότοπός μας. Εμείς (OCMC) παρέχουμε την υπηρεσία μας ως έχει, και δε δίνουμε υποσχέσεις ή εγγυήσεις σχετικά με την υπηρεσία."
      , liability: "Δεν ευθυνόμαστε για ζημιές ή απώλειες που προκύπτουν από τη χρήση ή την αδυναμία χρήσης της υπηρεσίας ή που προκύπτουν με άλλο τρόπο από αυτή τη συμφωνία."
      , release: "Είστε αποκλειστικά υπεύθυνοι για τη χρήση της υπηρεσίας. Είστε υπεύθυνοι για τη διασφάλιση ότι τα κείμενα ή και οι μεταφράσεις που εισάγετε είναι είτε δικές σας, είτε δημόσια, είτε ότι έχουν λάβει άδεια χρήσης γραπτή(π.χ. μέσω ηλεκτρονικού μηνύματος)."
      , cancellation: "Μπορείτε να μας ζητήσετε να διαγράψουμε το λογαριασμό χρήστη και τα προσωπικά δεδομένα.."
      , enhancements: "Αν μας ζητήσετε να τροποποιήσουμε ή να προσθέσουμε νέα χαρακτηριστικά σε αυτόν τον ιστότοπο και το αντίστοιχο λογισμικό, και πραγματοποιηθεί το αίτημά σας, εξακολουθούμε να διατηρούμε την πλήρη ιδιοκτησία και τα πνευματικά δικαιώματα του λογισμικού."
      , copyrights: "Κάνουμε ό,τι καλύτερο γίνεται ώστε να διασφαλίσουμε ότι τα κείμενα που παρέχουμε είναι από δημόσιο τομέα ή έχουν λάβει άδεια χρήσης.Αν πιστεύετε ότι οποιοδήποτε κείμενο εμπίπτει στην παραβίαση δικαιωμάτων, επικοινωνήστε μαζί μας για να μελετήσουμε την κατάσταση και να λάβουμε δράση όπου χρειαστεί."
      , backups: "Διατηρούμε αντίγραφα ασφαλείας όλων των δεδομένων. Ωστόσο είναι δικιά σας ευθύνη η λήψη καταχωρήσεων χρησιμοποιώντας «Οι Καταχωρήσεις μου» στη στήλη Μενού. Δεν φέρουμε καμία ευθύνη για την απώλεια των καταχωρήσεών σς αν αποτύχετε να τα σώσετε ή αν το αντίγραφο ασφαλείας των δεδομένων σας δεν είναι διαθέσιμο."
    }
  }
};
