...
const   labels = {
  en: {
    ...
    , help: {
      ...
      , videos: "How To..."
      , videoWarning: "It can take a few seconds or longer for a video to load.  How long it takes depends on your Internet speed.  If a video does not start playing right away, please wait."
      ...
      , videoLogonText: "Click the 'person' on the right of the menu bar.  Then click 'Logon'."
      ...
      , videoSearchTextText: "You can search the liturgical and biblical texts.  On the menu bar, click Search > Text. Further down on this page is a larger section on 'How to Search the Database', which you provide you more information."
      ...
      , videoNoteDownloadText: "You can search download your notes.  In the menu, select the user icon (it looks like a person), then select 'My Records'."
